package com.notivest.portfolioservice.valuation

import com.notivest.portfolioservice.client.marketdata.MarketDataPort
import com.notivest.portfolioservice.client.marketdata.Quote
import com.notivest.portfolioservice.valuation.models.PositionInput
import com.notivest.portfolioservice.valuation.models.PositionValuation
...
class ValuationCalculator(
    ...
    fun compute(
        ...
        val pairs =
            inputs.map { "${it.currency.uppercase()}$base" }
